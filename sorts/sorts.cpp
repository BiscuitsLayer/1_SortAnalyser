...
SortType::SortType ():
        name_ ("Sample sort name"),
        sortFunction_ (sorts::BogoSort)
        {}

SortType::SortType (std::string name, void (*sortFunction)(LogInt* begin, LogInt* end)):
        name_ (name),
        sortFunction_ (sortFunction)
        {}
